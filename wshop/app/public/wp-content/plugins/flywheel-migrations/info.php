...
if (!class_exists('FWLInfo')) :
	class FWLInfo {
		public $settings;
		public $config;
		public $plugname = 'flywheel';
		public $brandname = 'Flywheel';
		public $badgeinfo = 'fwlbadge';
		public $ip_header_option = 'fwlipheader';
		public $brand_option = 'fwlbrand';
		public $version = '4.69';
		public $webpage = 'https://www.getflywheel.com/migration';
		public $appurl = 'https://migrate.blogvault.net';
		public $slug = 'flywheel-migrations/flywheel.php';
		public $plug_redirect = 'fwlredirect';
		public $logo = '../assets/img/icon.png';
		public $brand_icon = '/assets/img/icon.png';
		...
		public function hasValidDBVersion() {
			return FWLInfo::DB_VERSION === $this->getCurrentDBVersion();
		}
		...
		public function canSetCWBranding() {
			if (FWLWPSiteInfo::isCWServer()) {

				$bot_protect_accounts = FWLAccount::accountsByType($this->settings, 'botprotect');
				if (sizeof($bot_protect_accounts) >= 1)
					return true;

				$bot_protect_accounts = FWLAccount::accountsByPattern($this->settings, 'email', '/@cw_user\.com$/');
				if (sizeof($bot_protect_accounts) >= 1)
					return true;
			}
