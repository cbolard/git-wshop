                            ...
                            if (!empty($charge_id)) {
                                if (isset($decoded['data']['object']['object']) && $decoded['data']['object']['object'] == 'refund') {
                                    ...
                                    if ($decoded['data']['object']['status'] == 'failed') {
                                        ...
                                        $order->add_order_note( __('Refund of '  . get_woocommerce_currency_symbol() . $decoded['data']['object']['amount'] . ' failed - ' . $reason, 'payment-gateway-stripe-and-woocommerce-integration'));
